...
import { Building2, Mail, Phone, ExternalLink, Edit2, MapPin, Users } from "lucide-react";
                        ...
                        <div className="relative flex flex-col h-full">
                            ...
                            <div className="space-y-2.5 flex-grow mb-5">
                                <div className="flex items-start gap-3 text-sm text-slate-500">
                                    ...
                                    <span className="line-clamp-2">{company.location.street}, {company.location.zip} {company.location.city}</span>
                                </div>
                            ...
                            <div className="pt-4 border-t border-[rgba(168,85,247,0.1)] flex items-center justify-between mt-auto">
                                <div className="flex items-center gap-2 text-xs text-slate-600">
                                    ...
                                    <span>
                                        Zaměstnanci:{" "}
                                        <span className="font-semibold text-slate-400">{company.employeeCount}</span>
                                    </span>
                                </div>

                                <div className="flex gap-1.5 translate-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200">
